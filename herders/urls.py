...
urlpatterns = [
    ...
    url(r'bestiary/', include([
        ...
        url(r'^bestiary/(?P<monster_element>[a-zA-Z]+)/$', views.bestiary, name='bestiary_element'),
        url(r'^bestiary/(?P<monster_id>[0-9]+)/$', views.bestiary_detail, name='bestiary_detail'),
    ]))
]
