...
urlpatterns = [
    ...
    url(r'^login/$', auth_views.LoginView.as_view(), {'authentication_form': CrispyAuthenticationForm}, name='login'),
    ...
    url(r'^password_reset/$', auth_views.PasswordResetView.as_view(), {'password_reset_form': CrispyPasswordResetForm}, name='password_reset'),
